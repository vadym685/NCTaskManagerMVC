...
public class MainControllerImpl implements MainControler {
    ...
    public MainControllerImpl(AbstractTaskList list, MainView view, Scanner scanner) {
        ...
        this.taskController = new TaskControllerImpl(list, view);
            ...
            if (choice == 0) {
                ...
                switch (choice) {
                    case 1:
                        ...
                        if (view.checkUserChoice()) taskController.addTask();
                        break;
                    case 2:
                        Output.print(QUESTION);
                        if (view.checkUserChoice()) taskController.editTask();
                        break;
                    case 3:
                        Output.print(QUESTION);
                        if (view.checkUserChoice()) taskController.deleteTask();
                        break;
                    case 4:
                        taskController.showTaskList();
                        break;
                    case 5:
                        taskController.showCalendar();
                        break;
                }
            }
        }
